                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                   <label class="control-label col-md-3">Nomor SP :</label>
                                       <input type="text" class="form-control select2" name="nomor_sp" style="width: 100%;" value="<?php echo $pecah['nomor_sp']; ?>" required>
                                   </div>
                                 </div>
                               </div>

                               <div class="row-no-print">
                                   <button class="btn btn-success float-right" name="ubah">Next <i class="fa fa-arrow-right"></i></button>
                               </div>
                             </form>
