...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2019 at 12:35 AM
...
(82, '48', 238172, 'smadlaskdanl', 90, 'Laki - laki', 'andiasndoal'),
(83, '48', 129381029, 'danidosaho', 90, 'Laki - laki', 'ksdnaoshdnoi'),
(84, '48', 928301, 'sdnlnalkd', 90, 'Laki - laki', 'andsoaidnsaol'),
(85, '48', 2147483647, 'adsnmdpadhn', 90, 'Laki - laki', 'adknmsaldihna');
...
INSERT INTO `data_sp` (`id_sp`, `id_rusun`, `id_blok`, `id_lantai`, `nomor_kk`, `nomor_sp`, `nama_sp`, `status`, `unit`, `nomor_va`) VALUES
(48, 24, 1, 1, 809890809, 2147483647, 'dnklasndklasndl', 'Relokasi', 9, 82193173);
...
INSERT INTO `sewa` (`id_sewa`, `status`, `lantai`, `blok`, `unit`, `tarif`) VALUES
(1, 'Relokasi', 1, 'D', 2, 100000);
...
--
ALTER TABLE `data_keluarga`
  MODIFY `id_data` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;

--
-- AUTO_INCREMENT for table `data_sp`
--
ALTER TABLE `data_sp`
  MODIFY `id_sp` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `sewa`
  MODIFY `id_sewa` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
