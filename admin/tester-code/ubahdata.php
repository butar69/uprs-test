...
<form method="post" enctype="multipart/form-data">
	<div class="form-group">
		<label>Id Merk</label>
		<input type="text" class="form-control" name="merk" value="<?php echo $pecah['id_merk']; ?>">
	<div class="form-group">
...
if (isset($_POST['ubah']))
{
	...
	{
		$koneksi->query("UPDATE produk SET nama_produk='$_POST[nama]', harga_produk='$_POST[harga]',deskripsi_produk='$_POST[deskripsi]',id_merk='$_POST[merk]' WHERE id_produk='$_GET[id]'");
	}
