<div class="content-wrapper">
  <section class="content-header">
      ...
      <div class="card">
        ...
        <div class="container-fluid">
                <h5>Rumah Susun Cipinang Muara</h5>
                 ...
                 <div class="card-body">
                      ...
                      <th colspan="8" style="text-align:right">Total:</th>
                        ...
                        <tbody class="text-center">
                                  ...
                                  // $id_sp = isset($_GET['id_sp']) ? $_GET['id_sp'] : '';
                									$result = "SELECT * FROM sewa_cimura";
                  ...
                  <div class="row no-print">
                    ...
                    <h1>
                        ...
                        <a href="index.php?halaman=import_cimura" class="btn btn-danger float-right" style="margin-right: 5px;"><i class="fa fa-upload"></i> Import</a>
                    </h1>
                  </div>
                </div>
                </div>
